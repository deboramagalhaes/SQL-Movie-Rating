...
-- 5 For each director, return the director's name together with the title(s) of the movie(s) 
...
-- 6 Remove all ratings where the movie's year is before 1970 or after 2000, and the rating is fewer than 4 stars.
